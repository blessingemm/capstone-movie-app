  ...
  return(
      <nav className="sticky top-0 z-50 w-full bg-[#1F1B2E] px-6 py-3 shadow-md">
        ...
        <div className="md:hidden mt-3 space-y-4 bg-[#1F1B2E] p-4 rounded-lg shadow-lg">
          ...
          <div className="flex space-x-3 pt-3 border-t border-[#FF4DA6]">
            <button className="flex-1 px-4 py-2 rounded-xl bg-[#2A243D] text-white font-semibold hover:bg-[#FF4DA6] transition">
              Log me in
            </button>
